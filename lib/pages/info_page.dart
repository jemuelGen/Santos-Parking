...
class _InfoPageState extends State<InfoPage> {
  ...
  void fetchArrivalTime() async {
    String fetchedArrival = await parkingLotService.fetchArrivalTime(user.uid);
    setState(() {
      arrival = fetchedArrival;
    });
  }

  void fetchDepartureTime() async {
    String fetchedDeparture = await parkingLotService.fetchDepartureTime(user.uid);
    setState(() {
      departure = fetchedDeparture;
    });
  }
